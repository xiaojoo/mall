...
@WebMvcTest(MemberStatisticsInfoController.class)
class MemberStatisticsInfoControllerTest {
    ...
    void testList() throws Exception {
        ...
        when(memberStatisticsInfoService.queryPage(any())).thenReturn(pageUtils);

        mockMvc.perform(get("/api/member/memberstatisticsinfo/list")
                        .param("page", "1")
                        .param("limit", "10"))
    ...
    void testInfo() throws Exception {
        MemberStatisticsInfoEntity entity = new MemberStatisticsInfoEntity();
        entity.setId(1L);
        when(memberStatisticsInfoService.getById(1L)).thenReturn(entity);

        mockMvc.perform(get("/api/member/memberstatisticsinfo/info/1"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.code").value(200));
    }
    ...
    void testSave() throws Exception {
        ...
        mockMvc.perform(post("/api/member/memberstatisticsinfo/save")
    ...
    void testUpdate() throws Exception {
        ...
        mockMvc.perform(post("/api/member/memberstatisticsinfo/update")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(entity)))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.code").value(200));
    ...
    void testDelete() throws Exception {
        mockMvc.perform(post("/api/member/memberstatisticsinfo/delete")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("[1,2]"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.code").value(200));
